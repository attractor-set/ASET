...
The rc12 release candidate intentionally preserves the rc11 wire profile and identity domains. The normative change is the complete machine-canon authority, multilingual generation, implementation-neutral conformance package and formalized model-based verification boundary.
