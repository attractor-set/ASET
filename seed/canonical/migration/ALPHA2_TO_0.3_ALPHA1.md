...
| mutable current Authority and escalation chain | immutable Authority proof material attached to the terminal record |
| open/escalate/resolve workflow state | append-only request and terminal-record store |

A 0.2 implementation cannot claim 0.3 conformance by renaming fields. It must implement the 0.3 exact-binding, local Authority proof, terminal uniqueness and fail-closed evaluation rules.
