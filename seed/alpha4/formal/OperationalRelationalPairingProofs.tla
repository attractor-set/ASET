...
PROOF
  BY DEF OperationalObserveUnknown,
         ObserveUnknown,
...
PROOF
  BY DEF OperationalRecognizeAllow,
         RecognizeAllow,
...
PROOF
  BY DEF OperationalRecognizeBlock,
         RecognizeBlock,
...
PROOF
  BY DEF OperationalPreserveUnknown,
         PreserveUnknown,
...
PROOF
  BY DEF OperationalPreserveAllow,
         PreserveAllow,
         TheoryPreserveAllow,
         ToTheoryRecognition
...
PROOF
  BY DEF OperationalPreserveBlock,
         PreserveBlock,
         TheoryPreserveBlock,
         ToTheoryRecognition
