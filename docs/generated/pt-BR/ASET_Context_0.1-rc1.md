...
Define contexto como espaço de nomes versionado, seus componentes imutáveis, projeções, composição e transições atômicas por patch.
...
Calcula uma raiz composta determinística a partir de componentes imutáveis assinados.
...
Cria uma nova versão do contexto por meio de um conjunto atômico de alterações autorizado.
