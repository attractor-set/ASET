...
Preserva proveniência, episódios e projeções de memória sem transformar retrieval em autoridade ou fato verificado.
...
Constrói uma projeção limitada da memória com proveniência e estado epistêmico explícito.
...
Altera a memória governada somente por meio de uma transição atômica autorizada.
