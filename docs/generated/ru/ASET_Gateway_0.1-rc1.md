...
Детерминированно отображает PromptManifest в provider request, не изменяя канонический контекст.
...
Детерминированно преобразует PromptManifest в запрос провайдеру, не изменяя канонический контекст.
