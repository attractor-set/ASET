...
**SHA-256 канонической модели:** `sha256:1ca83a0b1208eca014a977bfbe516cf9eead21f9db31ba36fcabdf9adf9c00f1`
...
Граница загрузки JSON ДОЛЖНА отклонять повторяющиеся ключи, не-UTF-8 и документы сверх установленного лимита.
...
Каждая попытка перехода ДОЛЖНА добавляться в хеш-связанный журнал с корнями состояния до и после.
...
Среда исполнения ДОЛЖНА создавать согласованную резервную копию средствами SQLite backup API.
