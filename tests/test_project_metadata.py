...
EXPECTED_DESCRIPTION = (
    "ASET is an open, implementation-neutral specification for a "
    "machine-interpretable semantic Seed with a minimal authority-scoped "
    "UNKNOWN, ALLOW or BLOCK resolution nucleus."
)
