...
BASE = [
    ...
    "seed/canonical/conformance/extension-conformance-protocol.json",
    "seed/canonical/schemas/extension-conformance-protocol.schema.json",
    "seed/canonical/schemas/extension-seed-binding.schema.json",
    "seed/canonical/schemas/extension-conformance-map.schema.json",
    "seed/canonical/schemas/extension-conformance-envelope.schema.json",
...
def expected() -> dict[str, Any]:
    ...
    return {
        ...
        "extension_conformance_protocol": "ASET-SEED-EXTENSION-CONFORMANCE-V1",
        "files": rows,
